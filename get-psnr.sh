...
parallel --link "ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -c:v libxvid -preset slow -bf 3 -b:v {2}k mpeg4/300k/{1/.}.mp4 \
  && ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -i mpeg4/300k/{1/.}.mp4 -lavfi psnr=stats_file=logs/mpeg4/300k/{1/.}.log -f null - \
  && ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -c:v libx264 -preset slow -bf 3 -b:v {3}k h264/300k/{1/.}.mp4 \
  ...
  ::: 249 238 231 251 233 242 242 \
  ::: 286 323 310 298 321 306 319
# average bitrate = 600k
parallel --link "ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -c:v libxvid -preset slow -bf 3 -b:v {2}k mpeg4/600k/{1/.}.mp4 \
  && ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -i mpeg4/600k/{1/.}.mp4 -lavfi psnr=stats_file=logs/mpeg4/600k/{1/.}.log -f null - \
  && ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -c:v libx264 -preset slow -bf 3 -b:v {3}k h264/600k/{1/.}.mp4 \
  && ffmpeg -y -v 0 -s cif -pix_fmt yuv420p -i yuv/{1/.}.yuv -i h264/600k/{1/.}.mp4 -lavfi psnr=stats_file=logs/h264/600k/{1/.}.log -f null -" \
  ::: yuv/crew_cif.yuv yuv/deadline_cif_300.yuv yuv/harbour_cif.yuv yuv/pamphlet_cif_300.yuv yuv/paris_cif_300.yuv yuv/silent_cif_300.yuv yuv/students_cif_300.yuv \
  ::: 559 515 492 598 484 522 535 \
  ::: 576 637 615 598 640 614 628
