...
x264name="${yuvname%%.yuv}-$preset-{2}-{1}.mp4"
mpegname="${yuvname%%.yuv}-mpeg4-{1}.mp4"

cmd="x264 --tune psnr --psnr --bitrate {1} --preset $preset --profile {2} --input-res=352x288 '$yuvname' -o '$x264name'"
parallel "hr; hyperfine --command-name='$x264name' '$cmd'; $cmd 2>&1|rg -N PSNR" ::: ${bitrates[@]} ::: ${profiles[@]}
